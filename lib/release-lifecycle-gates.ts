...
> = {
  ...
  test_signoff_complete: {
    label: "QA Sign-Off — Test Phase complete",
    description: "QA Sign-Off — Test Phase must be complete before leaving Testing for UAT.",
    ruleIds: ["VR-30"],
    dataReliability: "reliable",
  },
  uat_environment_booked: {
  ...
  signoffs_complete: {
    ...
    description: "All required Release sign-offs must be complete before Pending CAB.",
    ruleIds: ["VR-14"],
    dataReliability: "partial",
  },
  go_live_date_set: {
  ...
  ops_signoff_complete: {
    label: "Operations Review complete",
    description: "Operations Review must be complete before Ready.",
    ruleIds: ["VR-31"],
    dataReliability: "reliable",
  },
  business_signoff_complete: {
    label: "Business Review complete",
    description: "Business Review must be complete before Ready.",
    ruleIds: ["VR-31"],
    dataReliability: "reliable",
  },
  high_risks_mitigated: {
