...
- Voice **Admin console** (`/admin-voice`): restricted to `admin@releasedesk.com.au`. Track today’s usage, set per-user daily minute limits, ban/unban voice. Durable `VoiceUserPolicy` table; enforced on session mint + heartbeat disconnect.
